...
* Initial release
* Support for GBT-C5A, GBT-C7A, GBT-C12A, GBT-C16A collaborative robots
* Complete physics, sensor, and variant configurations
* Integrated Robotiq 2F-140 gripper variant
